...
const adSchema = new mongoose.Schema({
  ...
  targetPages: [{
    type: String,
    enum: ['home', 'public-buyer-home', 'buyer-home', 'buyer-agent-home', 'agent-home', 'vendor-home', 'vendor-dashboard', 'agent-dashboard', 'agent-shop', 'vendor-shop', 'view-shop', 'view-business', 'shop', 'category', 'product', 'search', 'all']
  }],
  targetUserTypes: [{
    type: String,
